...
parser.add_argument("phase", help="The path of the phase to subtract [Float]", type=str)
...
phase = _np.fromfile(args.phase, dtype= _gpf.type_mapping['FLOAT']).reshape(shape[::-1]).T
