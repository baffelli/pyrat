...
parser.add_argument("topo_phase", help="Topographic phase (unwrapped float) with the same shape as the other SLCS", type=str)
parser.add_argument("topo_phase_par", help="Topographic phase parameters", type=str)
parser.add_argument("topo_phase_master_par", help="SLC params of the master image used to generate the topographic phase", type=str)
parser.add_argument("topo_phase_slave_par", help="SLC params of the slave image used to generate the topographic phase", type=str)
